...
/*  Паттерн Bridge(Описатель,тело) - позволяем отделить абстракцию от элементов ее реализации,
    так чтобы и абстроакцию и реслизацию можно было изменять независимо друг от друга
